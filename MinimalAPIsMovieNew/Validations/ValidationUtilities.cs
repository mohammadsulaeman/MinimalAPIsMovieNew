namespace MinimalAPIsMovieNew.Validations
{
    public static class ValidationUtilities
    {
        ...
        public static string FirstLetterIsUppareCaseMessage = "The field {PropertyName} should start with uppercase";

        public static string EmailAddressMessage = "The field {PropertyName} is not a valid email address";

        public static string GreateThanDate(DateTime value) => "The field {PropertyName} should be greater than " + value.ToString("yyyy-mm-dd");
